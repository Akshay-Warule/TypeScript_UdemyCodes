...
//here function merge is used for combining two object 
...
// const mergeObj=merge({name:'Max',hobbies:['sportes']},{age:30});
...
function countLength<T extends Lenthify>(element:T){
